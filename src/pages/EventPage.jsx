...
const EventPage = () => {
  return (
    <div>
      <div className="relative w-full h-screen flex items-center justify-center bg-gradient-to-r from-slate-900 to-blue-950">
        <div className="absolute inset-0">
          <img
            src="img\events\blogprograms.png" 
      ...
      >
        <p className="text-lg font-semibold">
          We encourage individuals considering an MBA to explore all of their options
          when it comes to schools and finances. We hold several virtual events
          throughout the year that provide an opportunity for anyone to learn more
          about our mission, common application process, and fellowship opportunity.
        </p>
      </motion.div>
      ...
      <div className="w-full flex flex-col items-center justify-center px-6 py-12 ">
        ...
        <h2 className="text-3xl font-bold mt-6 mb-4 text-center">
          <span className="border-b-4 border-red-500 pb-1">Featured Programs</span>
        </h2>
        ...
        <div className="flex flex-col md:flex-row items-center max-w-5xl">
         ...
         <div className="md:ml-8 mt-4 md:mt-0 text-center md:text-left">
            ...
            <p className="text-gray-700 mt-2">
              Students, alumni, school, and corporate partners all point to our annual
              Orientation Program & Career Forum (affectionately called "The OP") as one
              of the most powerful, impactful aspects of The Consortium experience. It's an
              intense, hands-on opportunity for students to get real career development advice
              from the best educational institutions and corporations in the country.
              Corporate partners tell us the students at the OP are the best of the best,
              providing an unparalleled diversity recruiting opportunity.
            </p>
          </div>
        </div>
      </div>
